...
export default class PauseScene extends Phaser.Scene {
  ...
  create() {
    ...
    const wJoystick = mkToggle('Touch Joystick', () => getOptions().showTouchJoystick, (b) => setOptions({ showTouchJoystick: b }), 12)
    ...
    const widgets = [wShake.node, wFps.node, wJoystick.node, vol, volDown]
    let sel = 0
    const highlight = () => {
    ...
    attachGamepad(this, {
      ...
      confirm: () => {
        ...
        else if (widgets[sel] === wJoystick.node) wJoystick.toggle()
